...
import 'teacher_resume_model.dart';
export 'teacher_resume_model.dart';

class TeacherResumeWidget extends StatefulWidget {
  const TeacherResumeWidget({Key? key}) : super(key: key);

  @override
  _TeacherResumeWidgetState createState() => _TeacherResumeWidgetState();
}

class _TeacherResumeWidgetState extends State<TeacherResumeWidget> {
  late TeacherResumeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TeacherResumeModel());
